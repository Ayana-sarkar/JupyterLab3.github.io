    ...
    <section id="curriculum" class="curriculum">
        ...
        <div class="grid">
            ...
            <div class="card">
             ...
             <img width="753" height="582" alt="htt png" src="https://github.com/user-attachments/assets/283d3aea-eb7b-4042-9670-7c931a18ede9" alt="Visual Description" class="box-image"/>   
            </div>
        </div>
    </section>
